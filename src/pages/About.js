          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="card p-8">
              <div className="flex items-center mb-6">
                <div className="bg-prdf-cta rounded-full p-3 mr-4">
                  <svg
                ...
                <h2 className="text-2xl font-bold text-prdf-primary">
                  Our Mission
                </h2>
              </div>
            ...
            <div className="card p-8">
              <div className="flex items-center mb-6">
                <div className="bg-prdf-primary rounded-full p-3 mr-4">
                  <svg
                    className="w-8 h-8 text-white"
                    fill="currentColor"
                    viewBox="0 0 20 20"
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-prdf-text-dark leading-relaxed">
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="bg-prdf-cta rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                <svg
                  className="w-8 h-8 text-white"
                  fill="currentColor"
                  viewBox="0 0 20 20"
              ...
              <h3 className="text-xl font-bold text-prdf-primary mb-2">
                Excellence
              </h3>
              <p className="text-prdf-text-dark">
                Committed to the highest standards in all our endeavors
              </p>
            </div>
            <div className="text-center">
              <div className="bg-prdf-primary rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                <svg
                  className="w-8 h-8 text-white"
                  fill="currentColor"
                  viewBox="0 0 20 20"
            ...
            <div className="text-center">
              <div className="bg-prdf-accent rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                <svg
                  className="w-8 h-8 text-prdf-text-dark"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
            ...
            <div className="text-center">
              <div className="bg-prdf-secondary rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                <svg
                  className="w-8 h-8 text-prdf-text-dark"
                  fill="currentColor"
                  viewBox="0 0 20 20"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="card overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-prdf-cta font-semibold mb-2">
                  Executive Director
                </p>
                <p className="text-prdf-text-dark text-sm">
